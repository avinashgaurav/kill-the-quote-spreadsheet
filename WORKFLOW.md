...
| Regressions | 62 bugs that shipped cannot return unnoticed, including one asserting the deployed dataset is byte-identical to the generated one, and one that a FRESH CLONE type checks | 62/62 ✅ | no |
